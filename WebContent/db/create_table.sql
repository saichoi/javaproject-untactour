...
(
        ITEM_ID                                      CHAR(6)                 PRIMARY KEY                -- 상품코드(사진이름(~jpg))
      , ITEM_NAME                                VARCHAR2(100)    NOT NULL                      -- 상품명
      , ITEM_CONT                               VARCHAR2(1000)                                          -- 상품설명
      , CATEGORY_CODE_ID             CHAR(6)                                                         -- 카테고리번호 FK
...
(
        BASKET_ID             CHAR(6)              PRIMARY KEY                          -- 장바구니번호
       , ITEM_ID                  CHAR(6)                                                                -- 상품코드 FK
...
(
        ...
        PURCHASE_ID       CHAR(6)              PRIMARY KEY                          -- 장바구니번호
       , ITEM_ID                  CHAR(6)                                                                -- 상품코드 FK
       , CUSTOMER_ID     VARCHAR2(30)                                                     -- 회원아이디 FK
       , CNT                        CHAR(6)               NOT NULL                                -- 상품개수
       , REGDATE              DATE                    DEFAULT         SYSDATE       -- 등록날짜
...
(
       CATEGORY_CODE_ID           CHAR(6)                PRIMARY KEY               -- 카테고리번호 
