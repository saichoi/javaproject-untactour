						...
						<form class="validation-form" onsubmit="return test()"
							...
							<div class="row">
								...
								<div class="col-md-6 mb-3">
									<label for="name">아이디</label> <input type="text"
										class="form-control" name="customer_id" placeholder=""
										value="" required>
								...
								<div class="col-md-6 mb-3">
									<label for="nickname">닉네임</label> <input type="text"
										class="form-control" name="customer_nickname" placeholder=""
										value="" required>
							...
							<div class="mb-3">
								<label for="address">주소</label> <input type="text"
									class="form-control" name="address" placeholder="부산광역시 사하구"
									required>
							...
							<button class="btn btn-primary btn-lg btn-block btn-sub"
