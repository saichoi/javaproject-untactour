			...
			<div class="row gx-4 gx-lg-5 align-items-center">
				<div class="col-md-6">
					<img class="card-img-top mb-5 mb-md-0"
						src="../images/101.jpg" alt="..." />     <!-- ITEM_ID -->
				</div>
				<div class="col-md-6">
					<h1 class="display-5 fw-bolder">Shop item template</h1> <!-- ITEM_NAME -->
					<div class="fs-5 mb-5">
						<span>$40.00</span> <!-- PRICE -->
					</div>
					<p class="lead">Lorem ipsum dolor sit amet consectetur
						...
						blanditiis delectus ipsam minima ea iste laborum vero?</p><!-- ITEM_CONT -->
					<div class="d-flex">
