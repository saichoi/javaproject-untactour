...
<body>
  ...
  <!--  form action="/board?cmd=LOGIN&customer_id=${customer_id}" method="POST"> -->
  <form action="/board?cmd=LOGIN" method="POST">
    ...
    <div class="form-floating">
      <input type="text" class="form-control" name="customer_id" id="customer_id" placeholder="Account">
